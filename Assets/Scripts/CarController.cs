...
namespace Race
{
    ...
    public class CarController : NetworkBehaviour
    {
        ...
        private void Awake()
        {
            ...
            extrapolationTimer = new CountdownTimer(extrapolationLimit);  // It turns extrapolation off
        ...
        public void Move(Vector2 inputVector) {
            ...
            if (!input.IsBraking) {
                ...
                rb.velocity = Vector3.Lerp(rb.velocity, forwardWithoutY * targetSpeed,  networkTimer.MinTimeBetweenTics);
            }
        ...
        void HandleSteering(AxleInfo axleInfo, float steering) {
            if (axleInfo.steering) {
                float steeringMultiplier = input.IsBraking ? driftSteeringMultiplier : 1f;
